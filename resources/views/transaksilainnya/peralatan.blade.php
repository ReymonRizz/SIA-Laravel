    ...
    <table class="table table-bordered" id="datatable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><button class="btn btn-warning" onclick="editBeban('{{ $data }}')"><i class="fas fa-edit"></i> Edit Peralatan</button>&nbsp;<button class="btn btn-danger" onclick="deletePeralatan('{{ $data->id }}')"><i class="fas fa-trash"></i> Hapus Peralatan</button></td>
            </tr>
            @endforeach
        </tbody>
    </table>
...
<!-- modal Edit Beban -->
<div class="modal fade" id="editperalatanmdl" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <form action="/data-peralatan/edit" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Masa Manfaat Aset</label>
                        <select type="text" class="form-control" name="masa_manfaat" id="masa_manfaat_edit" />
                        <option value="3">3 Tahun</option>
                        <option value="5">5 Tahun</option>
                        <option value="10">10 Tahun</option>
                        </select>
